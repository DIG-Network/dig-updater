...
failure MUST enumerate every asset FILE NAME that was searched for — derived from the component's
declared `asset_kind`, so the diagnostic can never describe a shape the selector did not use. The

...
/// This is a small crate (a handful of source files); a scan that reads too few (a
/// wrong `CARGO_MANIFEST_DIR`, a moved `src/`, a walk that silently matched nothing) is
/// a broken guard, not a passing one, and must FAIL rather than vacuously succeed.
const MIN_FILES_SCANNED: usize = 4;
